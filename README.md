...
- <img src="https://smithery.ai/badge/aruuhii2yo/maxion-mcp-gateway" height="14"/> [Maxion](https://github.com/aruuhii2yo/maxion-mcp) - Zero-trust in-process binary admission gate, prompt injection defense, and autonomous thermal governor for MCP agents. Available on [Smithery](https://smithery.ai/servers/aruuhii2yo/maxion-mcp-gateway).
