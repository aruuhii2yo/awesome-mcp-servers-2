...
- [Maxion](https://github.com/aruuhii2yo/maxion-mcp) - In-process security gate, prompt injection defense, threat scanning and quarantine (Diamonize), encrypted credential vault (Quezar), and autonomous hardware governor (Maxion V16) for MCP AI agents.
